...
$errmsg_arr[] = 'Email address is not valid';
	...
	//Create INSERT query
	$qry = "INSERT INTO Users(First_Name, Last_Name, User_Name, Email_Address, Password, Country) VALUES('$first_name','$last_name', '$user_name', '$email_address','".md5($_POST['password'])."', '$country')";
	$result = @mysql_query($qry);
