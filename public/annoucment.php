...
<option value="brooklyn">Emergency</option>
<option value="queens">Jobs</option>
<option value="bronx">Sales</option>
<option value="manhattan">Other</option>
</select>
...
<p>
   <b> Write you announcement here </b>
</p>
